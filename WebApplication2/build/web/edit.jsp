...
<html>
    ...
    <center>
        <table width="80%" bgcolor="#eeeeee">
             ...
             <label>Nama Mahasiswa :</label><input type="text" name="nama" value"<%out.println(rs.getInt("nama")); %>" /> <br/>
             <label>Alamat :</label><input type="text" name="alamat" value"<%out.println(rs.getInt("alamat")); %>" /> <br/>
             <label>Program Studi : value"<%out.println(rs.getInt("prodi")); %>" </label>
